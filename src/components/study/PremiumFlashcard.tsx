...
import { X, ZoomIn, ZoomOut, Maximize2, Bookmark, BookmarkCheck, Sparkles } from "lucide-react";
  ...
  return (
    <div className="perspective-1000 w-full max-w-7xl mx-auto">
      ...
      >
        ...
        <Card
          className="absolute inset-0 backface-hidden glass-strong border-2 border-cyber-cyan/30 hover-glow overflow-hidden"
          style={{
        ...
        {/* Back of card (Answer) */}
        <Card
          className="absolute inset-0 backface-hidden glass-strong border-2 border-cyber-purple/40 shadow-neon-purple overflow-hidden"
          style={{
            backfaceVisibility: "hidden",
            WebkitBackfaceVisibility: "hidden",
